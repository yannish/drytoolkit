...
public class AnimationSystem
{
    ...
    public AnimationSystem(Animator animator, AnimationClip idleClip = null, DirectorUpdateMode mode = DirectorUpdateMode.GameTime)
    {
    ...
    private void TickOneShotBlending()
    {
        ...
        if(currOneShotBlendTime > (oneShotClip.length - currOneShotBlendOutTime))
            oneShotWeight = Mathf.Clamp01(1f - (currOneShotBlendTime - (oneShotClip.length - currOneShotBlendOutTime)) / currOneShotBlendOutTime);
    ...
    //... STATE:
    public void TransitionToStateClip(StateClipHandle stateClipHandle, float blendInTime = -1f, float startTime = 0f, float playbackSpeed = 1f)
    {
        TransitionToState(
    ...
    public void TransitionToState(AnimationClip newStateClip, float blendInTime, float startTime = 0f, float playbackSpeed = 1f)
    {
